...
> = {
  ...
  "power-trumps": {
    name: "Power trumps",
    blurb:
      "Pick one of your top two cards. The call rotates round the table; no card may be called twice on the same stat. Three powers: win big, or lose one extra card.",
    players: { min: 2, max: 6 },
    family: "trumps",
  },
  "squad-draft": {
